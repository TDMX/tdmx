...
public class PF_ECDHContextSchemeTest {
	...
	public void testEncrypt() throws CryptoException, IOException {
		...
		Encrypter e = ownFactory.getECDHEncrypter(CryptoScheme.PF_ECDH384_AES256_SLASH_AES256, passphrase, encodedSessionKey);
		assertNotNull(e);
	...
	public void testEncryptDecrypt_Aes_Twofish_LargeContent() throws CryptoException, IOException {
		...
		Encrypter e = ownFactory.getECDHEncrypter(CryptoScheme.PF_ECDH384_AES256_SLASH_TWOFISH256, passphrase, encodedSessionKey);
		assertNotNull(e);
		Decrypter d = otherFactory.getECDHDecrypter(CryptoScheme.PF_ECDH384_AES256_SLASH_TWOFISH256, passphrase, session);
		assertNotNull(d);
	...
	public void testEncryptDecrypt_Aes_Serpent_LargeContent() throws CryptoException, IOException {
		...
		Encrypter e = ownFactory.getECDHEncrypter(CryptoScheme.PF_ECDH384_AES256_SLASH_SERPENT256, passphrase, encodedSessionKey);
		assertNotNull(e);
		Decrypter d = otherFactory.getECDHDecrypter(CryptoScheme.PF_ECDH384_AES256_SLASH_SERPENT256, passphrase, session);
		assertNotNull(d);
	...
	public void testEncryptDecrypt_Aes_Aes_RSA_LargeContent() throws CryptoException, IOException {
		...
		Encrypter e = ownFactory.getECDHEncrypter(CryptoScheme.PF_ECDH384_AES256plusRSA_SLASH_AES256, passphrase, encodedSessionKey);
		assertNotNull(e);
		Decrypter d = otherFactory.getECDHDecrypter(CryptoScheme.PF_ECDH384_AES256plusRSA_SLASH_AES256, passphrase, session);
		assertNotNull(d);
	...
	public void testEncryptDecrypt_Aes_Twofish_RSA_LargeContent() throws CryptoException, IOException {
		...
		Encrypter e = ownFactory.getECDHEncrypter(CryptoScheme.PF_ECDH384_AES256plusRSA_SLASH_TWOFISH256, passphrase, encodedSessionKey);
		assertNotNull(e);
		Decrypter d = otherFactory.getECDHDecrypter(CryptoScheme.PF_ECDH384_AES256plusRSA_SLASH_TWOFISH256, passphrase, session);
		assertNotNull(d);
	...
	public void testEncryptDecrypt_Aes_Serpent_RSA_LargeContent() throws CryptoException, IOException {
		...
		Encrypter e = ownFactory.getECDHEncrypter(CryptoScheme.PF_ECDH384_AES256plusRSA_SLASH_SERPENT256, passphrase, encodedSessionKey);
		assertNotNull(e);
		Decrypter d = otherFactory.getECDHDecrypter(CryptoScheme.PF_ECDH384_AES256plusRSA_SLASH_SERPENT256, passphrase, session);
		assertNotNull(d);
