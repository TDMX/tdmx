...
public class PF_RSA_ECDHCascadeSchemeTest {
	...
	public void testEncrypt() throws CryptoException, IOException {
		...
		Encrypter e = ownFactory.getECDHEncrypter(CryptoScheme.RSA_SLASH_PF_RSA_ECDH384_AES256, passphrase, encodedSessionKey);
		assertNotNull(e);
	...
	public void testEncryptDecrypt_SingleByte() throws CryptoException, IOException {
		...
		Decrypter d = otherFactory.getECDHDecrypter(CryptoScheme.RSA_SLASH_PF_RSA_ECDH384_AES256, passphrase, session);
	...
	public void testEncryptDecrypt_Twofish_LargeContent() throws CryptoException, IOException {
		...
		Encrypter e = ownFactory.getECDHEncrypter(CryptoScheme.RSA_SLASH_PF_RSA_ECDH384_TWOFISH256, passphrase, encodedSessionKey);
		assertNotNull(e);
		Decrypter d = otherFactory.getECDHDecrypter(CryptoScheme.RSA_SLASH_PF_RSA_ECDH384_TWOFISH256, passphrase, session);
		assertNotNull(d);
	...
	public void testEncryptDecrypt_Serpent_LargeContent() throws CryptoException, IOException {
		...
		Encrypter e = ownFactory.getECDHEncrypter(CryptoScheme.RSA_SLASH_PF_RSA_ECDH384_SERPENT256, passphrase, encodedSessionKey);
		assertNotNull(e);
		Decrypter d = otherFactory.getECDHDecrypter(CryptoScheme.RSA_SLASH_PF_RSA_ECDH384_SERPENT256, passphrase, session);
		assertNotNull(d);
