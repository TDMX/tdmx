...
public class SslHandshakeFailureIntegrationTest {
	...
	@Test
	@Ignore("until we have the serviceprovider.tdmx.org back")
	public void test() throws Exception {
		KeystoreFileCredentialProvider cp = new KeystoreFileCredentialProvider();
		cp.setKeystoreAlias("client");
		cp.setKeystoreFilePath("src/test/resources/wrong-uc.keystore"); // USER with wrong PrivateKey
		...
		try {
			...
			log.info("Expected SSLHandshake Issue. ", e);
		}
	}
