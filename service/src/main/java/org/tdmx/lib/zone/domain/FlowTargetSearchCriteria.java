...
/**
 * The SearchCriteria for a FlowTarget.
 * 
 * @author Peter Klauser
 * 
 */
public class FlowTargetSearchCriteria {
	...
	// CONSTRUCTORS
	// -------------------------------------------------------------------------
	public FlowTargetSearchCriteria(PageSpecifier pageSpecifier) {
	...
	public AgentFilterCriteria getTarget() {
		return target;
	}
