...
/**
 * Manages a pooled DataSource per PartitionId. The PartitionId is shared
 * with the DynamicDataSource via ThreadLocal storage since the
 * javax.sql.DataSource does not foresee passing in context.
 * 
