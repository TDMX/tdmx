...
/**
 * The DnsDomainZoneService manages DnsDomainZone entities.
 * 
 * @author Peter
 * 
 */
public interface DnsDomainZoneService {
	...
	/**
	 * List of DnsDomainZone entries ordered in decreasing validUntilTime.
	 * 
	 * @param domainName
	 * @return
	 */
