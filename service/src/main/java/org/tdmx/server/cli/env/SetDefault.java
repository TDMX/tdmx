...
@Cli(name = "default:set", description = "sets the default values.")
public class SetDefault extends AbstractCliCommand {
	...
	public void run(CliPrinter out) {
		if (verbose != null) {
			out.println("Setting verbosity to " + verbose);
			cliPrinterFactory.setVerbose(verbose);
		}
	}
