...
public class DescribeZoneAdministratorCredentials implements CommandExecutable {
	...
	public void run(CliPrinter out) {
		...
		out.println(
				"certificate=" + CertificateIOUtils.safeX509certsToPem(new PKIXCertificate[] { zac.getPublicCert() }));
		out.println("fingerprint=" + zac.getPublicCert().getFingerprint());
	}
