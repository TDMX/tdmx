...
@Cli(name = "address:delete", description = "deletes an address in a domain at the service provider.")
public class DeleteAddress implements CommandExecutable {
	...
	public void run(CliPrinter out) {
		...
		org.tdmx.core.api.v01.zas.DeleteAddress deleteAddressRequest = new org.tdmx.core.api.v01.zas.DeleteAddress();
		Address a = new Address();
		a.setLocalname(localName);
		a.setDomain(domain);
		deleteAddressRequest.setAddress(a);
		deleteAddressRequest.setSessionId(sessionResponse.getSession().getSessionId());
		...
		if (deleteAddressResponse.isSuccess()) {
			...
			out.println("Unable to delete ", a, ". ", deleteAddressResponse.getError());
		}
	}
