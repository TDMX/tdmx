...
@Cli(name = "user:suspend", description = "suspends a user at the service provider.")
public class SuspendUserCredentials implements CommandExecutable {
	...
	public void run(PrintStream out) {
		...
		if (searchUserResponse.isSuccess() && !searchUserResponse.getUsers().isEmpty()) {
			...
			modifyUserRequest.setStatus(CredentialStatus.SUSPENDED);
