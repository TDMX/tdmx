...
@Cli(name = "service:create", description = "creates a service in a domain at the service provider.")
public class CreateService implements CommandExecutable {
	...
	public void run(CliPrinter out) {
		...
		s.setDomain(domain);
		createServiceRequest.setService(s);
		createServiceRequest.setSessionId(sessionResponse.getSession().getSessionId());
		...
		if (createServiceResponse.isSuccess()) {
			...
			out.println("Unable to create ", s, ". ", createServiceResponse.getError());
		}
	}
