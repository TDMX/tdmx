...
public class SK_PayloadEncrypter implements Encrypter {
	...
	public SK_PayloadEncrypter(KeyPair ownSigningKey, PublicKey otherSigningKey, byte[] passphrase,
		...
		// TODO System.out.println("SK KEY: " + ByteArray.asHex(aesKey));
		// TODO System.out.println("SK IV: " + ByteArray.asHex(aesIv));
	}
