...
public class PF_ECDHPayloadDecrypter implements Decrypter {
	...
	public PF_ECDHPayloadDecrypter(KeyPair ownSigningKey, PublicKey otherSigningKey, byte[] passphrase,
			KeyPair sessionKey, boolean rsaEnabled, StreamCipherAlgorithm payloadCipher) throws CryptoException {
