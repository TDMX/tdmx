/*
 * Copyright (c) 2012, 2013, Oracle and/or its affiliates. All rights reserved. DO NOT ALTER OR REMOVE COPYRIGHT NOTICES
 * OR THIS FILE HEADER.
 * 
...
/**
 * PJK: Adapted from sun.security.util.UntrustedCertificate bundled with OpenJDK
 * 
 * A utility class to check if a certificate is untrusted. This is an internal mechanism that explicitly marks a
 * certificate as untrusted, normally in the case that a certificate is known to be used for malicious reasons.
 * 
 * <b>Attention</b>: This check is NOT meant to replace the standard PKI-defined validation check, neither is it used as
 * an alternative to CRL.
 */
public final class UntrustedCertificates {

	public final static Map<String, TrustStoreEntry> untrustedCerts = new HashMap<>();
	...
	private static void add(String alias, String pemCert) {
		...
		try (ByteArrayInputStream is = new ByteArrayInputStream(pemCert.getBytes())) {
			...
			throw new RuntimeException("Incorrect untrusted certificate: " + alias, e);
		}
	}
	...
	static {
		...
		add("digicert-server-cross-to-cybertrust-4C0E636A", "-----BEGIN CERTIFICATE-----\n"
		...
		add("digicert-server-cross-to-entrust-ca-4C0E636A", "-----BEGIN CERTIFICATE-----\n"
		...
		add("java-media-pretrusted-9F191E4E", "-----BEGIN CERTIFICATE-----\n"
		...
		add("java-fx10-pretrusted-4A1EF027", "-----BEGIN CERTIFICATE-----\n"
		...
		add("javafx-runtime-pretrusted-6217C0FF", "-----BEGIN CERTIFICATE-----\n"
		...
		add("solaris-internal-dev-A0E1CD8C", "-----BEGIN CERTIFICATE-----\n"
		...
		add("info-at-diginotar-cyber-ca-cross-to-gte-cybertrust-0727100D", "-----BEGIN CERTIFICATE-----\n"
		...
		add("diginotar-cyber-ca-cross-to-gte-cybertrust-07270FF9", "-----BEGIN CERTIFICATE-----\n"
		...
		add("diginotar-cyber-ca-cross-to-gte-cybertrust-07271003", "-----BEGIN CERTIFICATE-----\n"
		...
		add("info-at-diginotar-root-ca-cross-to-entrust-secure-server-469C3CC9", "-----BEGIN CERTIFICATE-----\n"
		...
		add("info-at-diginotar-root-ca-cross-to-entrust-secure-server-469C2CAF", "-----BEGIN CERTIFICATE-----\n"
		...
		add("diginotar-pkioverheid-organisatie-cross-to-nederlanden-013134BF", "-----BEGIN CERTIFICATE-----\n"
		...
		add("diginotar-pkioverheid-overheid-enb-cross-to-nederlanden-013169B0", "-----BEGIN CERTIFICATE-----\n"
		...
		add("diginotar-pkioverheid-overheid-cross-to-nederlanden-01314476", "-----BEGIN CERTIFICATE-----\n"
		...
		add("diginotar-services-1024-ca-cross-to-entrust-469C2CB0", "-----BEGIN CERTIFICATE-----\n"
		...
		add("buster-paper-comercial-ltda-72A67312", "-----BEGIN CERTIFICATE-----\n"
		...
		add("buster-assistencia-tecnica-electronica-ltda-3FD74D2F", "-----BEGIN CERTIFICATE-----\n"
		...
		add("clearesult-consulting-inc-2AA84F44", "-----BEGIN CERTIFICATE-----\n"
