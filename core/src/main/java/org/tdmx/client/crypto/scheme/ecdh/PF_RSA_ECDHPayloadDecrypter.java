...
public class PF_RSA_ECDHPayloadDecrypter implements Decrypter {
	...
	public PF_RSA_ECDHPayloadDecrypter(KeyPair ownSigningKey, PublicKey otherSigningKey, byte[] passphrase,
			KeyPair sessionKey, StreamCipherAlgorithm payloadCipher) throws CryptoException {
