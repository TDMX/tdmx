 ...
 * 
 */
public class RSA_ECDHContextDecrypter implements Decrypter {
	...
	public RSA_ECDHContextDecrypter(KeyPair ownSigningKey, PublicKey otherSigningKey, KeyPair sessionKey,
	...
	public InputStream getInputStream(InputStream encryptedData, byte[] encryptionContext) throws CryptoException {
		...
		byte[] kdf = DigestAlgorithm.SHA_384.kdf(ByteArray.append(encodedSessionKey, sharedSecret));
