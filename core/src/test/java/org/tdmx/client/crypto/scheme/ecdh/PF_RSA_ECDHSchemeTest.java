...
public class PF_RSA_ECDHSchemeTest {
	...
	public void testEncrypt() throws CryptoException, IOException {
		...
		Encrypter e = ownFactory.getECDHEncrypter(CryptoScheme.RSA_SLASH_PF_RSA_ECDH384_AES256plusTWOFISH256,
	...
	public void testEncryptDecrypt_SingleByte() throws CryptoException, IOException {
		...
		Decrypter d = otherFactory.getECDHDecrypter(CryptoScheme.RSA_SLASH_PF_RSA_ECDH384_AES256plusTWOFISH256,
				passphrase, session);
	...
	public void testEncryptDecrypt_AesSerpent_LargeContent() throws CryptoException, IOException {
		...
		Encrypter e = ownFactory.getECDHEncrypter(CryptoScheme.RSA_SLASH_PF_RSA_ECDH384_AES256plusSERPENT256,
				passphrase, encodedSessionKey);
		assertNotNull(e);
		Decrypter d = otherFactory.getECDHDecrypter(CryptoScheme.RSA_SLASH_PF_RSA_ECDH384_AES256plusSERPENT256,
				passphrase, session);
		assertNotNull(d);
	...
	public void testEncryptDecrypt_TwofishAes_LargeContent() throws CryptoException, IOException {
		...
		Encrypter e = ownFactory.getECDHEncrypter(CryptoScheme.RSA_SLASH_PF_RSA_ECDH384_TWOFISH256plusAES256,
				passphrase, encodedSessionKey);
		assertNotNull(e);
		Decrypter d = otherFactory.getECDHDecrypter(CryptoScheme.RSA_SLASH_PF_RSA_ECDH384_TWOFISH256plusAES256,
				passphrase, session);
		assertNotNull(d);
	...
	public void testEncryptDecrypt_TwofishSerpent_LargeContent() throws CryptoException, IOException {
		...
		Encrypter e = ownFactory.getECDHEncrypter(CryptoScheme.RSA_SLASH_PF_RSA_ECDH384_TWOFISH256plusSERPENT256,
				passphrase, encodedSessionKey);
		assertNotNull(e);
		Decrypter d = otherFactory.getECDHDecrypter(CryptoScheme.RSA_SLASH_PF_RSA_ECDH384_TWOFISH256plusSERPENT256,
				passphrase, session);
		assertNotNull(d);
	...
	public void testEncryptDecrypt_SerpentAes_LargeContent() throws CryptoException, IOException {
		...
		Encrypter e = ownFactory.getECDHEncrypter(CryptoScheme.RSA_SLASH_PF_RSA_ECDH384_SERPENT256plusAES256,
				passphrase, encodedSessionKey);
		assertNotNull(e);
		Decrypter d = otherFactory.getECDHDecrypter(CryptoScheme.RSA_SLASH_PF_RSA_ECDH384_SERPENT256plusAES256,
				passphrase, session);
		assertNotNull(d);
	...
	public void testEncryptDecrypt_SerpentTwofish_LargeContent() throws CryptoException, IOException {
		...
		Encrypter e = ownFactory.getECDHEncrypter(CryptoScheme.RSA_SLASH_PF_RSA_ECDH384_SERPENT256plusTWOFISH256,
				passphrase, encodedSessionKey);
		assertNotNull(e);
		Decrypter d = otherFactory.getECDHDecrypter(CryptoScheme.RSA_SLASH_PF_RSA_ECDH384_SERPENT256plusTWOFISH256,
				passphrase, session);
		assertNotNull(d);
