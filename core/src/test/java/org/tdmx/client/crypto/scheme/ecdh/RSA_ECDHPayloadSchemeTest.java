...
public class RSA_ECDHPayloadSchemeTest {
	...
	public void testEncrypt() throws CryptoException, IOException {
		...
		Encrypter e = ownFactory.getEncrypter(IntegratedCryptoScheme.ECDH384_RSA_SLASH_AES256, encodedSessionKey);
		assertNotNull(e);
	...
	public void testEncryptDecrypt_SingleByte() throws CryptoException, IOException {
		...
		Decrypter d = otherFactory.getDecrypter(IntegratedCryptoScheme.ECDH384_RSA_SLASH_AES256, session);
	...
	public void testEncryptDecrypt_Aes_Twofish_LargeContent() throws CryptoException, IOException {
		...
		Encrypter e = ownFactory.getEncrypter(IntegratedCryptoScheme.ECDH384_RSA_SLASH_TWOFISH256, encodedSessionKey);
		assertNotNull(e);
		Decrypter d = otherFactory.getDecrypter(IntegratedCryptoScheme.ECDH384_RSA_SLASH_TWOFISH256, session);
		assertNotNull(d);
	...
	public void testEncryptDecrypt_Aes_Serpent_LargeContent() throws CryptoException, IOException {
		...
		Encrypter e = ownFactory.getEncrypter(IntegratedCryptoScheme.ECDH384_RSA_SLASH_SERPENT256, encodedSessionKey);
		assertNotNull(e);
		Decrypter d = otherFactory.getDecrypter(IntegratedCryptoScheme.ECDH384_RSA_SLASH_SERPENT256, session);
		assertNotNull(d);
