...
public class PF_ECDHPayloadSchemeTest {
	...
	public void testEncrypt() throws CryptoException, IOException {
		...
		Encrypter e = ownFactory.getECDHEncrypter(CryptoScheme.NONE_SLASH_PF_ECDH384_AES256, passphrase, encodedSessionKey);
		assertNotNull(e);
	...
	public void testEncryptDecrypt_Twofish_LargeContent() throws CryptoException, IOException {
		...
		Encrypter e = ownFactory.getECDHEncrypter(CryptoScheme.NONE_SLASH_PF_ECDH384_TWOFISH256, passphrase, encodedSessionKey);
		assertNotNull(e);
	...
	public void testEncryptDecrypt_Serpent_LargeContent() throws CryptoException, IOException {
		...
		Encrypter e = ownFactory.getECDHEncrypter(CryptoScheme.NONE_SLASH_PF_ECDH384_SERPENT256, passphrase, encodedSessionKey);
		assertNotNull(e);
	...
	public void testEncryptDecrypt_Aes_RSA_LargeContent() throws CryptoException, IOException {
		...
		Encrypter e = ownFactory.getECDHEncrypter(CryptoScheme.RSA_SLASH_PF_ECDH384_AES256, passphrase, encodedSessionKey);
		assertNotNull(e);
	...
	public void testEncryptDecrypt_Twofish_RSA_LargeContent() throws CryptoException, IOException {
		...
		Encrypter e = ownFactory.getECDHEncrypter(CryptoScheme.RSA_SLASH_PF_ECDH384_TWOFISH256, passphrase, encodedSessionKey);
		assertNotNull(e);
	...
	public void testEncryptDecrypt_Serpent_RSA_LargeContent() throws CryptoException, IOException {
		...
		Encrypter e = ownFactory.getECDHEncrypter(CryptoScheme.RSA_SLASH_PF_ECDH384_SERPENT256, passphrase, encodedSessionKey);
		assertNotNull(e);
